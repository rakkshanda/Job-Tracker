...
### Pomodoro Sessions (optional but recommended)

If you want to use the built-in Pomodoro timer and insights, create the sessions table and open policies for quick local use:
